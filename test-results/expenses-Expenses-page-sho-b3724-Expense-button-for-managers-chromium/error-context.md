...
- Name: expenses.spec.ts >> Expenses page >> shows the Add Expense button for managers
- Location: e2e\expenses.spec.ts:119:7
...
Locator: getByRole('button', { name: /add expense/i })
Expected: visible
Timeout: 5000ms
