...
- Name: home.spec.ts >> Home page >> steps with commands should show a code block
- Location: e2e\home.spec.ts:97:7
...
Call log:
  ...
  - waiting for locator('.step__command')
