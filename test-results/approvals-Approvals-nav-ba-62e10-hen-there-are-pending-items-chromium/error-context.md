...
- Name: approvals.spec.ts >> Approvals nav badge >> shows a badge on the Approvals nav item when there are pending items
- Location: e2e\approvals.spec.ts:216:7
...
Locator: locator('app-sidebar a[href="/approvals"]').locator('.badge')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('app-sidebar a[href="/approvals"]').locator('.badge')
