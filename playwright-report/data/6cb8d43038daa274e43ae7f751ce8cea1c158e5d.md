...
- Name: home.spec.ts >> Home page >> first step should reference Angular CLI verification
- Location: e2e\home.spec.ts:87:7
...
Locator: locator('.step__title').first()
Expected substring: "Verified Angular CLI"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('.step__title').first()
